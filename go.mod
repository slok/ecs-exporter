module github.com/form3tech-oss/ecs-exporter

go 1.16

require (
	github.com/Sirupsen/logrus v0.11.1-0.20161128225724-e400ff7861bc
...
replace github.com/slok/ecs-exporter => github.com/form3tech-oss/ecs-exporter v1.1.2-0.20210813144012-431c2d1c0b6e
